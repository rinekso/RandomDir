...
{
    [SerializeField] float _minZoom = .7f;
    ...
    void ScrollZoom(float input){
        _currentZoom *= 1 + input * _mouseWheelSensitivity;
        print(_currentZoom);
        _currentZoom = Mathf.Clamp(_currentZoom, _minZoom, _maxZoom);
        print("min :"+_minZoom+"/max :"+_maxZoom);
        print("clamp: "+Mathf.Clamp(_currentZoom, _minZoom, _maxZoom));
